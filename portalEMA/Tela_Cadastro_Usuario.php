...
<html>
    <head>
        <meta charset="utf-8">
        <title>Portal EMA - Tela de Cadastro de Usuário</title>
    ...
    <body>
        ...
        <div class="card col-6">
            ...
            <div class="card-body">
                <form method="POST" action="../portalEMA/controllers/cadastro_usuario.php">
                    <div class="form-row">
                        ...
                        <br>
                        <button style="width: 100%" class="btn btn-primary btn-block" type="submit"><i style="padding-right: 1%;" class="fas fa-circle-plus"></i>Cadastrar</button>
                    </div>
                </form>
            </div>
        </div>
