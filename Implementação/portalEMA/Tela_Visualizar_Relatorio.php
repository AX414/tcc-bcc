...
<html>
    ...
    <body>
        ...
        if (!$relatorio) {
            ...
            echo '<textarea disabled="true" style="font-family: "Courier New";" class="form-control">'. $relatorio['nao_previstos'] .'</textarea>';
            echo '<br><h3><b>Erros do Relatório</b></h3><br>';
            echo '<textarea type="text" disabled="true" style="font-family: "Courier New";" class="form-control" >'. $relatorio['erros'] .'</textarea>';
            echo '</form>';
            echo '</div>';
            echo '</div>';
            echo '</div>';
